    ...
    <div class="container results-grid">
        ...
        <div class="verdict-banner <?= strtolower($article['verdict']) ?>">
            ...
            <div class="verdict-meta">
                <p class="source-url">Analyzed on <?= date('M d., Y H:i', strtotime($article['analyzed_at'])) ?> UTC . Article URL</p>
                <p class="source-title">https://example.com/article/submitted-link</p> 
            </div>
            ...
            <div class="main-column">
                ...
                <div class="content-card actions-card">
                    <div class="action-buttons">
                        ...
                        <a href="index.php" class="btn-outline">Check Another</a>
                ...
                <div class="sidebar-card blockchain-card">
                    ...
                    <p class="sidebar-desc">This result is permanently stored and cannot be altered or deleted.</p>
                    
                    <ul class="meta-list">
                        <li><span>Status</span> <span class="text-green">Confirmed</span></li>
                        <li><span>Network</span> <span>Polygon</span></li>
                        <li><span>Transaction Hash</span> <span class="hash-text"><?= htmlspecialchars($article['blockchain_tx']) ?></span></li>
                        <li><span>Timestamp</span> <span><?= date('M d. Y . H:i', strtotime($article['analyzed_at'])) ?> UTC</span></li>
                        <li><span>Block</span> <span>448452936</span></li>
                    </ul>
                    <a href="#" class="btn-outline-small">View Polygonscan</a>
                </div>

                <div class="sidebar-card stats-card">
                    <h4 class="sidebar-title text-cyan">Analysis Stats</h4>
                    <ul class="meta-list underline-list">
                        <li><span>Source Check</span> <span>14</span></li>
                        <li><span>Claim Bounce</span> <span>4</span></li>
                        <li><span>Time to analyze</span> <span>8.3s</span></li>
                    </ul>
                </div>
